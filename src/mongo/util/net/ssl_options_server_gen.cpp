...
#include "../../../src/mongo/util/net/ssl_options_server_gen.h"
...
#if defined(MONGO_CONFIG_SSL_CERTIFICATE_SELECTORS)
        section
            .addOptionChaining("net.tls.clusterCertificateSelector", "tlsClusterCertificateSelector", moe::String, "SSL/TLS Certificate in system store for internal TLS authentication", {"tls.ssl.clusterCertificateSelector"}, {"sslClusterCertificateSelector"}, moe::OptionSection::OptionParserUsageType::IDLAutoGeneratedCode)
            .setSources(moe::SourceAll)
