...
from resmokelib.core import process
from resmokelib.core import jasper_process
...
class Resmoke(object):  # pylint: disable=too-many-instance-attributes
    ...
    def _setup_jasper(self):
        ...
        proto_file = os.path.join(root_dir, "buildscripts", "resmoke", "resmokelib", "core", "jasper.proto")
        try:
        ...
        # meant to be tracked by git or linted.
